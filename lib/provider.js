...
(function() {
  ...
  Provider = (function() {
    ...
    Provider.prototype._valid_parameters = function(body) {
      var correct_version, has_resource_link_id, omits_content_item_params, omits_presentation_lis_params;
      if (!body) {
        return false;
      }
      ...
      omits_presentation_lis_params = (body.launch_presentation_return_url == null) && (body.lis_result_sourcedid == null);
      omits_content_item_params = (body.resource_link_id == null) && (body.resource_link_title == null) && (body.resource_link_description == null);
      return correct_version && (body.lti_message_type === 'basic-lti-launch-request' && has_resource_link_id) || (body.lti_message_type === 'ContentItemSelectionRequest' && omits_content_item_params && omits_presentation_lis_params) || (body.lti_message_type === 'ContentItemUpdateRequest' && omits_presentation_lis_params);
    };
